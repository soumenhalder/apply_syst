...
var2max = 'theta_max'
var1_Ntuple = 'B_l1_p' 
var2_Ntuple = 'B_l1_theta'
ignore= ['variable', 'charge']
...
def systematics_table():
    ...
    X = pd.read_csv('Rdtmc_piFe_B0-9_all.csv',dtype='str')
...
if __name__ == "__main__":
    ...
    final = ntup.merge(syst,left_on=['v1_binid_k1','v2_binid_k1'] ,right_on=['v1_binid','v2_binid'])
